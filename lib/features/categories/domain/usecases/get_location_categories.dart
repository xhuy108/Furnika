...
class GetLocationCategories implements UseCaseWithoutParams<List<Category>> {
  final CategoryRepository _repository;

  GetLocationCategories(this._repository);

  @override
  ResultFuture<List<Category>> call() async =>
      await _repository.getLocationCategories();
}
